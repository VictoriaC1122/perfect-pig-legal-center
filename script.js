const SUPPORT_URL = "https://github.com/VictoriaC1122/perfect-pig-legal-center/issues/new";
...
const COPY = {
  "zh-Hant": {
    ...
    contactTitle: "聯繫開發者",
    contactBody: "如有隱私、版權、購買或遊戲問題，可透過 GitHub 支援頁提交訊息。",
    contactAction: "開啟支援請求",
    contactNote: "請勿在公開內容中附上付款資料、Apple ID 或其他敏感資訊。",
    appName: "完美養豬",
    ...
    privacy: {
      ...
      sections: [
        ...
        {
          title: "3. 資料使用與分享",
          paragraphs: ["上述遊戲資料用於恢復進度、顯示個人化內容及維持遊戲規則。App 目前不要求建立帳號，也不使用第三方廣告、跨 App 追蹤或分析 SDK；本機遊戲資料不會傳送到開發者伺服器或出售給第三方。"],
        },
        {
          title: "4. 通知",
        ...
        {
          title: "6. 保存、刪除與安全性",
          paragraphs: ["遊戲進度主要儲存在你的裝置上。刪除 App 會移除本機資料，且進度可能無法復原；Apple 保存的購買紀錄則依其政策管理。請勿在 GitHub 公開支援內容中張貼付款資訊或其他敏感資料。"],
        },
        {
          title: "7. 網站與第三方服務",
          paragraphs: ["本網站由 GitHub Pages 託管，並使用 Google Fonts。造訪網站時，服務供應商可能依其政策處理 IP 位址、瀏覽器類型與基本連線紀錄。點擊 Apple 或 GitHub 連結後，將適用該服務的隱私政策。"],
        },
        {
          title: "8. 兒童、政策更新與聯絡",
  ...
  "zh-Hans": {
    ...
    contactTitle: "联系开发者",
    contactBody: "如有隐私、版权、购买或游戏问题，可通过 GitHub 支持页提交信息。",
    contactAction: "发起支持请求",
    contactNote: "请勿在公开内容中附上付款资料、Apple ID 或其他敏感信息。",
    appName: "完美养猪",
    ...
    privacy: {
      ...
      sections: [
        { title: "1. 适用范围", paragraphs: ["本政策适用于《完美养猪》iPhone、iPad 与 Mac Catalyst App，以及本官方法律与支持网站。"] },
        {
          ...
          items: ["小猪名称、性别与选填的体重设置。", "养成进度、互动记录、聊天记录、图鉴收藏、任务与活动状态。", "金币、宝石、已解锁内容及其他游戏设置。", "通知授权状态与本地提醒设置。"],
        },
        { title: "3. 数据使用与分享", paragraphs: ["上述游戏数据用于恢复进度、显示个性化内容及维持游戏规则。App 目前不要求创建账户，也不使用第三方广告、跨 App 跟踪或分析 SDK；本地游戏数据不会传送到开发者服务器或出售给第三方。"] },
        ...
        { title: "6. 保存、删除与安全性", paragraphs: ["游戏进度主要保存在你的设备上。删除 App 会移除本地数据，且进度可能无法恢复；Apple 保存的购买记录则依其政策管理。请勿在 GitHub 公开支持内容中张贴付款信息或其他敏感数据。"] },
        { title: "7. 网站与第三方服务", paragraphs: ["本网站由 GitHub Pages 托管，并使用 Google Fonts。访问网站时，服务提供商可能依其政策处理 IP 地址、浏览器类型与基本连接记录。点击 Apple 或 GitHub 链接后，将适用该服务的隐私政策。"] },
  ...
  en: {
    ...
    contactBody: "For privacy, copyright, purchase, or gameplay questions, submit a message through our GitHub support page.",
    contactAction: "Open a Support Request",
    contactNote: "Do not include payment details, your Apple ID, or other sensitive information in public posts.",
    appName: "Perfect Pig",
    ...
    privacy: {
      ...
      sections: [
        { title: "1. Scope", paragraphs: ["This policy applies to the Perfect Pig app for iPhone, iPad, and Mac Catalyst, as well as this official legal and support website."] },
        {
          ...
          items: ["Your pig's name, gender, and optional weight setting.", "Growth progress, interactions, chat history, card collection, tasks, and event status.", "Coins, gems, unlocked content, and other game settings.", "Notification authorization status and local reminder settings."],
        },
        { title: "3. How Data Is Used and Shared", paragraphs: ["This game data restores progress, displays personalized content, and enforces game rules. The app currently requires no account and uses no third-party advertising, cross-app tracking, or analytics SDKs. Local game data is not sent to a developer server or sold to third parties."] },
        ...
        { title: "6. Retention, Deletion, and Security", paragraphs: ["Game progress is stored primarily on your device. Deleting the app removes local data, and progress may not be recoverable. Purchase records held by Apple are managed under Apple's policies. Never post payment information or other sensitive data in a public GitHub support request."] },
        { title: "7. Website and Third-Party Services", paragraphs: ["This website is hosted by GitHub Pages and uses Google Fonts. When you visit, those providers may process your IP address, browser type, and basic connection logs under their own policies. Apple's or GitHub's privacy policy applies after you follow a link to those services."] },
  ...
  ja: {
    ...
    contactBody: "プライバシー、著作権、購入、ゲームに関するご質問は、GitHub のサポートページからお送りください。",
    contactAction: "サポートを依頼する",
    contactNote: "公開投稿には、支払い情報、Apple ID、その他の機密情報を記載しないでください。",
    appName: "パーフェクトピッグ",
    ...
    privacy: {
      ...
      sections: [
        { title: "1. 適用範囲", paragraphs: ["本ポリシーは、iPhone、iPad、Mac Catalyst 向けアプリ『パーフェクトピッグ』および本公式リーガル・サポートサイトに適用されます。"] },
        {
          ...
          items: ["こぶたの名前、性別、任意で設定する体重。", "育成状況、ふれあい、チャット履歴、カードコレクション、ミッション、イベント状況。", "コイン、ジェム、解放済みコンテンツ、その他のゲーム設定。", "通知の許可状況と端末内のリマインダー設定。"],
        },
        { title: "3. 利用目的と共有", paragraphs: ["これらのゲームデータは、進行状況の復元、内容のパーソナライズ、ゲームルールの維持に利用します。現在、アカウント登録は不要です。第三者広告、アプリをまたぐトラッキング、解析 SDK は使用しておらず、端末内のゲームデータを開発者のサーバーへ送信したり、第三者へ販売したりすることはありません。"] },
        ...
        { title: "6. 保存、削除、安全性", paragraphs: ["ゲームの進行状況は主に端末内に保存されます。アプリを削除するとローカルデータも削除され、復元できない場合があります。Apple が保持する購入履歴は Apple のポリシーに従って管理されます。GitHub の公開サポート投稿には、支払い情報などの機密情報を記載しないでください。"] },
        { title: "7. ウェブサイトと外部サービス", paragraphs: ["本サイトは GitHub Pages でホストされ、Google Fonts を利用しています。アクセス時に、各事業者がそれぞれのポリシーに基づき、IP アドレス、ブラウザの種類、基本的な接続ログを処理する場合があります。Apple または GitHub へのリンクを開いた後は、各サービスのプライバシーポリシーが適用されます。"] },
