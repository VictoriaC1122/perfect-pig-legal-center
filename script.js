  ...
  "zh-Hant": {
    ...
    privacy: {
      ...
      sections: [
        ...
        {
          title: "6. 保存、刪除與安全性",
          paragraphs: ["遊戲進度與消耗型寶石餘額主要儲存在你的裝置上。刪除 App 會移除本機資料，且完整進度與未使用寶石可能無法復原；若 iCloud 可用，永久解鎖項目可能在重新安裝後恢復。Apple 保存的購買紀錄則依其政策管理。請勿在 GitHub 公開支援內容中張貼付款資訊或其他敏感資料。"],
        },
        {
          title: "7. 網站與第三方服務",
  ...
  "zh-Hans": {
    ...
    privacy: {
      ...
      sections: [
        ...
        { title: "6. 保存、删除与安全性", paragraphs: ["游戏进度与消耗型宝石余额主要保存在你的设备上。删除 App 会移除本地数据，且完整进度与未使用宝石可能无法恢复；若 iCloud 可用，永久解锁项目可能在重新安装后恢复。Apple 保存的购买记录则依其政策管理。请勿在 GitHub 公开支持内容中张贴付款信息或其他敏感数据。"] },
  ...
  ja: {
    ...
    privacy: {
      ...
      sections: [
        ...
        { title: "6. 保存、削除、安全性", paragraphs: ["ゲームの進行状況と消費型ジェム残高は主に端末内に保存されます。アプリを削除するとローカルデータも削除され、完全な進行状況と未使用ジェムは復元できない場合があります。iCloud が利用可能な場合、永久解放項目は再インストール後に復元されることがあります。Apple が保持する購入履歴は Apple のポリシーに従って管理されます。GitHub の公開サポート投稿には、支払い情報などの機密情報を記載しないでください。"] },
